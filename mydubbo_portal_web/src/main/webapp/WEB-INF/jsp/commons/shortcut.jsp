  ...
  <div class="pW">
    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	...
      	<a href="http://localhost:8088/">免费注册</a>
      </li>
      <!--<li id='qiyeLogin'><a href='http://www.sfme.me/login.jhtml' target='_blank' rel='nofollow'>员工福利</a></li>-->
      <li class="myOrder"><a name="sfbest_hp_hp_head_OrderList" class="trackref" href="http://localhost:8089/" rel="nofollow">我的订单</a></li>
      <li class="menus">
        <a name="sfbest_hp_hp_head_home1" href="http://home.e3mall.cn/my/index/" rel="nofollow" class="trackref t">我的优选</a><b></b>
        <span class="outline"></span>
        <span class="blank"></span>
        <div class="dd">
          <div><a name="sfbest_hp_hp_head_home2" class="trackref" href="http://localhost:8089/" rel="nofollow">我的订单</a></div>
      ...
      <li class="d3 tShow"><a name="sfbest_hp_hp_head_weibo" class="trackref" title="关注华瑞商城微博" href="http://weibo.com/sfbest" rel="nofollow" target="_blank"><q></q></a></li>
      <li class="d4 tShow"><q></q><!--微信-->
         <div class="dd">
         <div class="sf_wx_t">关注华瑞商城微信</div>
         <div class="sf_wx"></div>
        </div>
        <div class="corner">
          <div class="aBg"></div>

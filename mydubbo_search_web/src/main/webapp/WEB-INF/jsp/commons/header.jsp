...
<div id="header">
  <div class="header_inner">
    ...
    <div class="search">
      <form action="http://localhost:8085/search" id="searchForm" name="query" method="POST">
    ...
    <div class="shopingcar" id="topCart">
      <s class="setCart"></s><a href="http://localhost:8089/cart/cart" class="t" rel="nofollow">我的购物车</a><b id="cartNum">0</b>
